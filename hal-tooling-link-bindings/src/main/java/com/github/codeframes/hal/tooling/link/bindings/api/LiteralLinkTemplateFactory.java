...
/**
 * A LinkTemplateFactory implementation that simply returns a given linkRelType href property.
 */
public class LiteralLinkTemplateFactory implements LinkTemplateFactory {

    /**
     * Returns the literal value, linkRelType.href.
     *
     * @param linkRelType the linkRelType to construct a Link Template from
     * @return {@code linkRelType.getHref()}
     */
    @Override
