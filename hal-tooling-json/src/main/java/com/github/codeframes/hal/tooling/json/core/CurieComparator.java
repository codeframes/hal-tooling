...
/**
 * A Comparator for sorting {@link Curie}'s by name lexicographically.
 */
public class CurieComparator implements Comparator<Curie> {

    @Override
    public int compare(Curie curie1, Curie curie2) {
        return curie1.getName().compareTo(curie2.getName());
    }
}
