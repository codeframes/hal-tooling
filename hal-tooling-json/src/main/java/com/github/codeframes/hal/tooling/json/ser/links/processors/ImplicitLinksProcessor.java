...
class ImplicitLinksProcessor extends ImplicitLinkProcessorBase<Iterable<Link>> implements LinkProcessor {

    ImplicitLinksProcessor(BeanPropertyWriter property) {
        super(property);
    }
